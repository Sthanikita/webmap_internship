const map=new maplibregl.Map({
    container:"map",
    style:"https://api.baato.io/api/v1/styles/breeze?key=bpk.VZoCAzLNn1fdR8UDoJhNv1lchYKDwwZHB3jWPEpdK52I",
    zoom:8,
    center:[85.3222,27.7103]
})
const mapData=
    {
        ...
        "features": [
          ...
          // ... (repeat for all features, changing "Confidence": "NN" to "Confidence": NN)
        ]
      }
